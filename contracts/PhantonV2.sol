...
contract PhantonV2 is Initializable, ERC20Upgradeable, ERC20BurnableUpgradeable, OwnableUpgradeable, PausableUpgradeable, ERC20PermitUpgradeable,  UUPSUpgradeable, ReentrancyGuardUpgradeable {
    ...
    function setMaximumSupply(uint _maximumSupply) public onlyOwner {
        maximumSupply = _maximumSupply * 10 ** decimals();
    }
